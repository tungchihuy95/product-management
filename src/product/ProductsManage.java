...
public class ProductsManage implements IProducts<Products> {
    ...
    static {
        ...
        products.add(new Products(11, "TV", 20000000));
        products.add(new Products(12, "Tu lanh", 35000000));
        products.add(new Products(13, "May giat", 11000000));
        products.add(new Products(14, "Dieu hoa", 8000000));
        products.add(new Products(15, "Lo vi song", 5000000));
    }
    @Override
